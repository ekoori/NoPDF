...
public static class CommandDocs
{
    ...
    public static readonly IReadOnlyList<CommandDoc> All = new[]
    {
        ...
        new CommandDoc("print", "File", "[range]", "Print using the defaults from the config (no dialog)"),
        new CommandDoc("printdialog", "File", "[range]", "Print via a dialog; can save the choices as the :print defaults"),
        ...
        new CommandDoc("hint", "Navigation", "", "Label every link on screen; type a label to follow it", "follow"),
        ...
        new CommandDoc("hand", "Annotations", "", "View tool: drag to pan, click links"),
